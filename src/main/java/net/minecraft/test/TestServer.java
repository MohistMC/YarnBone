...
extends MinecraftServer {
    ...
    public static TestServer create(Thread thread, LevelStorage.Session session, ResourcePackManager resourcePackManager, Collection<GameTestBatch> batches, BlockPos pos) {
        ...
        DataConfiguration lv = new DataConfiguration(new DataPackSettings(new ArrayList<String>(resourcePackManager.getNames()), List.of()), FeatureFlags.FEATURE_MANAGER.getFeatureSet());
        ...
        try {
            ...
            SaveLoader lv5 = (SaveLoader)Util.waitAndApply(executor -> SaveLoading.load(lv4, arg2 -> {
