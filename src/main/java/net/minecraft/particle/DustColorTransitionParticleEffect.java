...
extends AbstractDustParticleEffect {
    ...
    public static final ParticleEffect.Factory<DustColorTransitionParticleEffect> FACTORY = new ParticleEffect.Factory<DustColorTransitionParticleEffect>(){
        ...
        @Override
        public DustColorTransitionParticleEffect read(ParticleType<DustColorTransitionParticleEffect> arg, StringReader stringReader) throws CommandSyntaxException {
        ...
        @Override
        public DustColorTransitionParticleEffect read(ParticleType<DustColorTransitionParticleEffect> arg, PacketByteBuf arg2) {
