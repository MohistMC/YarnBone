...
public record SculkChargeParticleEffect(float roll) implements ParticleEffect
{
    ...
    public static final ParticleEffect.Factory<SculkChargeParticleEffect> FACTORY = new ParticleEffect.Factory<SculkChargeParticleEffect>(){
        ...
        @Override
        public SculkChargeParticleEffect read(ParticleType<SculkChargeParticleEffect> arg, StringReader stringReader) throws CommandSyntaxException {
            stringReader.expect(' ');
        ...
        @Override
        public SculkChargeParticleEffect read(ParticleType<SculkChargeParticleEffect> arg, PacketByteBuf arg2) {
