...
implements Waterloggable {
    ...
    public void onProjectileHit(World world, BlockState state, BlockHitResult hit, ProjectileEntity projectile) {
        BlockPos lv;
        if (world.isThundering() && projectile instanceof TridentEntity && ((TridentEntity)projectile).hasChanneling() && world.isSkyVisible(lv = hit.getBlockPos())) {
            LightningEntity lv2 = EntityType.LIGHTNING_BOLT.create(world);
            if (lv2 != null) {
            ...
            world.playSound(null, lv, SoundEvents.ITEM_TRIDENT_THUNDER, SoundCategory.WEATHER, 5.0f, 1.0f);
        }
    }
