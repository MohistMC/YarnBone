...
implements Equipment {
    ...
    public static boolean dispenseArmor(BlockPointer pointer, ItemStack armor) {
        ...
        List<Entity> list = pointer.getWorld().getEntitiesByClass(LivingEntity.class, new Box(lv), EntityPredicates.EXCEPT_SPECTATOR.and(new EntityPredicates.Equipable(armor)));
        if (list.isEmpty()) {
            return false;
        }
