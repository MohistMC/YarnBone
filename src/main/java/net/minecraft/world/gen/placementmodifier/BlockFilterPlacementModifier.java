...
extends AbstractConditionalPlacementModifier {
    public static final Codec<BlockFilterPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)BlockPredicate.BASE_CODEC.fieldOf("predicate")).forGetter(arg -> arg.predicate)).apply((Applicative<BlockFilterPlacementModifier, ?>)instance, BlockFilterPlacementModifier::new));
