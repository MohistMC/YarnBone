...
extends AbstractCountPlacementModifier {
    public static final Codec<NoiseThresholdCountPlacementModifier> MODIFIER_CODEC = RecordCodecBuilder.create(instance -> instance.group(((MapCodec)Codec.DOUBLE.fieldOf("noise_level")).forGetter(arg -> arg.noiseLevel), ((MapCodec)Codec.INT.fieldOf("below_noise")).forGetter(arg -> arg.belowNoise), ((MapCodec)Codec.INT.fieldOf("above_noise")).forGetter(arg -> arg.aboveNoise)).apply((Applicative<NoiseThresholdCountPlacementModifier, ?>)instance, NoiseThresholdCountPlacementModifier::new));
