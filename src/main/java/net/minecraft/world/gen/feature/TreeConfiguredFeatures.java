...
public class TreeConfiguredFeatures {
    ...
    public static void bootstrap(Registerable<ConfiguredFeature<?, ?>> featureRegisterable) {
        ...
        ConfiguredFeatures.register(featureRegisterable, CHERRY_BEES_005, Feature.TREE, TreeConfiguredFeatures.cherry().decorators(List.of(lv5)).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(lv2)).build());
        ConfiguredFeatures.register(featureRegisterable, SUPER_BIRCH_BEES, Feature.TREE, TreeConfiguredFeatures.superBirch().decorators(ImmutableList.of(lv6)).build());
        ...
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv2)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv4)).build());
        ConfiguredFeatures.register(featureRegisterable, OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.oak().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_0002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv2)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_002, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv4)).build());
        ConfiguredFeatures.register(featureRegisterable, BIRCH_BEES_005, Feature.TREE, TreeConfiguredFeatures.birch().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_0002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv2)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_002, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv4)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES_005, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv5)).build());
        ConfiguredFeatures.register(featureRegisterable, FANCY_OAK_BEES, Feature.TREE, TreeConfiguredFeatures.fancyOak().decorators(List.of(lv6)).build());
    }
}
