...
extends TrunkPlacer {
    ...
    private void setLog(TestableWorld arg, BiConsumer<BlockPos, BlockState> biConsumer, Random arg2, BlockPos.Mutable arg3, TreeFeatureConfig arg4, BlockPos arg5, int i, int j, int k) {
        arg3.set(arg5, i, j, k);
