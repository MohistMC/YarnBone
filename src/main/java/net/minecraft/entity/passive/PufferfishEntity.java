...
extends FishEntity {
    ...
    extends Goal {
        ...
        public boolean canStart() {
            List<LivingEntity> list = this.pufferfish.world.getEntitiesByClass(LivingEntity.class, this.pufferfish.getBoundingBox().expand(2.0), arg -> BLOW_UP_TARGET_PREDICATE.test(this.pufferfish, (LivingEntity)arg));
            return !list.isEmpty();
        }
