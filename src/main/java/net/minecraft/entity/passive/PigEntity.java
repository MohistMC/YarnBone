...
Saddleable {
    ...
    public LivingEntity getControllingPassenger() {
        PlayerEntity lv;
        Entity entity;
        if (this.isSaddled() && (entity = this.getFirstPassenger()) instanceof PlayerEntity && ((lv = (PlayerEntity)entity).getMainHandStack().isOf(Items.CARROT_ON_A_STICK) || lv.getOffHandStack().isOf(Items.CARROT_ON_A_STICK))) {
            return lv;
        }
        return null;
    }
