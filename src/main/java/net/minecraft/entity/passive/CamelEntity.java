...
Saddleable {
    ...
    public void updatePassengerPosition(Entity passenger) {
        ...
        Vec3d lv = new Vec3d(0.0, 0.0, f).rotateY(-this.bodyYaw * ((float)Math.PI / 180));
    ...
    public LivingEntity getControllingPassenger() {
        Entity lv;
        if (!this.getPassengerList().isEmpty() && this.isSaddled() && (lv = this.getPassengerList().get(0)) instanceof LivingEntity) {
