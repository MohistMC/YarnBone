    ...
    public void tickMovement() {
        ...
        if (!this.world.isClient) {
            ...
            for (int i = 0; i < 4; ++i) {
                ...
                BlockPos lv2 = new BlockPos(j, k = MathHelper.floor(this.getY()), l = MathHelper.floor(this.getZ() + (double)((float)(i / 2 % 2 * 2 - 1) * 0.25f)));
                if (!this.world.getBlockState(lv2).isAir() || !lv.canPlaceAt(this.world, lv2)) continue;
