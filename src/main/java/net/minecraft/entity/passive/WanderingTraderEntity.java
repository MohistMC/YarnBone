...
extends MerchantEntity {
    ...
    protected void fillRecipes() {
        ...
        if (this.world.getEnabledFeatures().contains(FeatureFlags.UPDATE_1_20) && (lvs3 = (TradeOffers.Factory[])TradeOffers.ONE_TWENTY_WANDERING_TRADER_TRADES.get(1)) != null) {
            lvs = ArrayUtils.addAll(lvs, lvs3);
        }
