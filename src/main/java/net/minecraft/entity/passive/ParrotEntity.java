    ...
    extends FlyGoal {
        ...
        private Vec3d locateTree() {
            ...
            for (BlockPos lv4 : iterable) {
                BlockState lv5;
                boolean bl;
                if (lv.equals(lv4) || !(bl = (lv5 = this.mob.world.getBlockState(lv3.set((Vec3i)lv4, Direction.DOWN))).getBlock() instanceof LeavesBlock || lv5.isIn(BlockTags.LOGS)) || !this.mob.world.isAir(lv4) || !this.mob.world.isAir(lv2.set((Vec3i)lv4, Direction.UP))) continue;
