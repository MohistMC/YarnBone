...
extends HostileEntity {
    ...
    public static boolean canSpawn(EntityType<EndermiteEntity> type, WorldAccess world, SpawnReason spawnReason, BlockPos pos, Random arg5) {
        if (EndermiteEntity.canSpawnIgnoreLightLevel(type, world, spawnReason, pos, arg5)) {
