...
extends HostileEntity {
    ...
    extends Goal {
        ...
        private boolean wander() {
            Random lv = ((LivingEntity)this.entity).getRandom();
            BlockPos lv2 = ((PatrolEntity)this.entity).world.getTopPosition(Heightmap.Type.MOTION_BLOCKING_NO_LEAVES, ((Entity)this.entity).getBlockPos().add(-8 + lv.nextInt(16), 0, -8 + lv.nextInt(16)));
