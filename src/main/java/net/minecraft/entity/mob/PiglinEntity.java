...
InventoryOwner {
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        ...
        if (this.getWorld().getEnabledFeatures().contains(FeatureFlags.UPDATE_1_20) && (lv = source.getAttacker()) instanceof CreeperEntity && (lv2 = (CreeperEntity)lv).shouldDropHead()) {
