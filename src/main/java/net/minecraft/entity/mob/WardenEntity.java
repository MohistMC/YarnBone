...
implements VibrationListener.Callback {
    ...
    public void tick() {
        ...
        if (world instanceof ServerWorld) {
            ...
            this.gameEventHandler.getListener().tick(lv);
    ...
    public boolean isValidTarget(@Nullable Entity entity) {
        ...
        if (!this.world.getWorldBorder().contains(lv.getBoundingBox())) return false;
        return true;
    }
    ...
    public void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        VibrationListener.createCodec(this).encodeStart(NbtOps.INSTANCE, this.gameEventHandler.getListener()).resultOrPartial(LOGGER::error).ifPresent(arg2 -> nbt.put("listener", (NbtElement)arg2));
    }
    ...
    public void readCustomDataFromNbt(NbtCompound nbt) {
        ...
        if (nbt.contains("listener", NbtElement.COMPOUND_TYPE)) {
            VibrationListener.createCodec(this).parse(new Dynamic<NbtCompound>(NbtOps.INSTANCE, nbt.getCompound("listener"))).resultOrPartial(LOGGER::error).ifPresent(arg -> this.gameEventHandler.setListener((VibrationListener)arg, this.world));
        }
    }
    ...
    public void increaseAngerAt(@Nullable Entity entity, int amount, boolean listening) {
        if (!this.isAiDisabled() && this.isValidTarget(entity)) {
            WardenBrain.resetDigCooldown(this);
            boolean bl2 = !(this.getBrain().getOptionalRegisteredMemory(MemoryModuleType.ATTACK_TARGET).orElse(null) instanceof PlayerEntity);
    ...
    public boolean accepts(ServerWorld world, GameEventListener listener, BlockPos pos, GameEvent event, GameEvent.Emitter emitter) {
        ...
        return !(entity instanceof LivingEntity) || this.isValidTarget(lv = (LivingEntity)entity);
    }
