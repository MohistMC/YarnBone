...
Targeter {
    ...
    protected void writeCustomDataToNbt(NbtCompound nbt) {
        ...
        if (this.attack != null) {
            Interaction.CODEC.encodeStart(NbtOps.INSTANCE, this.attack).result().ifPresent(arg2 -> nbt.put(ATTACK_KEY, (NbtElement)arg2));
        }
        if (this.interaction != null) {
            Interaction.CODEC.encodeStart(NbtOps.INSTANCE, this.interaction).result().ifPresent(arg2 -> nbt.put(INTERACTION_KEY, (NbtElement)arg2));
        }
