...
extends AbstractMinecartEntity {
    ...
    protected void explode(@Nullable DamageSource damageSource, double power) {
        if (!this.world.isClient) {
            ...
            this.world.createExplosion(this, damageSource, null, this.getX(), this.getY(), this.getZ(), (float)(4.0 + this.random.nextDouble() * 1.5 * e), false, World.ExplosionSourceType.TNT);
            this.discard();
        }
    }
