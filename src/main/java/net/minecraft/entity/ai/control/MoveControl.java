...
implements Control {
    ...
    private boolean isPosWalkable(float x, float z) {
        ...
        return lv == null || (lv2 = lv.getNodeMaker()) == null || lv2.getDefaultNodeType(this.entity.world, MathHelper.floor(this.entity.getX() + (double)x), this.entity.getBlockY(), MathHelper.floor(this.entity.getZ() + (double)z)) == PathNodeType.WALKABLE;
    }
