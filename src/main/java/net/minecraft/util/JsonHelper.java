...
public class JsonHelper {
    ...
    public static Item asItem(JsonElement element, String name) {
        if (element.isJsonPrimitive()) {
            ...
            return (Item)Registries.ITEM.getOrEmpty(new Identifier(string2)).orElseThrow(() -> new JsonSyntaxException("Expected " + name + " to be an item, was unknown string '" + string2 + "'"));
        }
