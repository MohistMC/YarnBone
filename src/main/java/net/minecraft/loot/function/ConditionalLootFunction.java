...
implements LootFunction {
    ...
    implements JsonSerializer<T> {
        ...
        public void toJson(JsonObject jsonObject, T arg, JsonSerializationContext jsonSerializationContext) {
            if (!ArrayUtils.isEmpty(((ConditionalLootFunction)arg).conditions)) {
                jsonObject.add("conditions", jsonSerializationContext.serialize(((ConditionalLootFunction)arg).conditions));
            }
        }
