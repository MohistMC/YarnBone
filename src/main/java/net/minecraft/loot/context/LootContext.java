...
public class LootContext {
    ...
    public static class Builder {
        ...
        public LootContext build(LootContextType type) {
            ...
            return new LootContext(lv, this.luck, this.world, minecraftServer.getLootManager()::getTable, minecraftServer.getPredicateManager()::get, this.parameters, this.drops);
        }
    }
}
