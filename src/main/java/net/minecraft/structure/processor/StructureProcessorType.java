...
public interface StructureProcessorType<P extends StructureProcessor> {
    ...
    public static final Codec<StructureProcessorList> PROCESSORS_CODEC = Codec.either(((MapCodec)LIST_CODEC.fieldOf("processors")).codec(), LIST_CODEC).xmap(either -> either.map(arg -> arg, arg -> arg), Either::left);
