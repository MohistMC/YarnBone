...
implements AdvancementTabGenerator {
    ...
    public void accept(RegistryWrapper.WrapperLookup lookup, Consumer<Advancement> exporter) {
        Advancement lv = Advancement.Builder.create().display(Blocks.GRASS_BLOCK, (Text)Text.translatable("advancements.story.root.title"), (Text)Text.translatable("advancements.story.root.description"), new Identifier("textures/gui/advancements/backgrounds/stone.png"), AdvancementFrame.TASK, false, false, false).criterion("crafting_table", InventoryChangedCriterion.Conditions.items(Blocks.CRAFTING_TABLE)).build(exporter, "story/root");
        Advancement lv2 = Advancement.Builder.create().parent(lv).display(Items.WOODEN_PICKAXE, (Text)Text.translatable("advancements.story.mine_stone.title"), (Text)Text.translatable("advancements.story.mine_stone.description"), null, AdvancementFrame.TASK, true, true, false).criterion("get_stone", InventoryChangedCriterion.Conditions.items(ItemPredicate.Builder.create().tag(ItemTags.STONE_TOOL_MATERIALS).build())).build(exporter, "story/mine_stone");
        Advancement lv3 = Advancement.Builder.create().parent(lv2).display(Items.STONE_PICKAXE, (Text)Text.translatable("advancements.story.upgrade_tools.title"), (Text)Text.translatable("advancements.story.upgrade_tools.description"), null, AdvancementFrame.TASK, true, true, false).criterion("stone_pickaxe", InventoryChangedCriterion.Conditions.items(Items.STONE_PICKAXE)).build(exporter, "story/upgrade_tools");
        Advancement lv4 = Advancement.Builder.create().parent(lv3).display(Items.IRON_INGOT, (Text)Text.translatable("advancements.story.smelt_iron.title"), (Text)Text.translatable("advancements.story.smelt_iron.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron", InventoryChangedCriterion.Conditions.items(Items.IRON_INGOT)).build(exporter, "story/smelt_iron");
        Advancement lv5 = Advancement.Builder.create().parent(lv4).display(Items.IRON_PICKAXE, (Text)Text.translatable("advancements.story.iron_tools.title"), (Text)Text.translatable("advancements.story.iron_tools.description"), null, AdvancementFrame.TASK, true, true, false).criterion("iron_pickaxe", InventoryChangedCriterion.Conditions.items(Items.IRON_PICKAXE)).build(exporter, "story/iron_tools");
        Advancement lv6 = Advancement.Builder.create().parent(lv5).display(Items.DIAMOND, (Text)Text.translatable("advancements.story.mine_diamond.title"), (Text)Text.translatable("advancements.story.mine_diamond.description"), null, AdvancementFrame.TASK, true, true, false).criterion("diamond", InventoryChangedCriterion.Conditions.items(Items.DIAMOND)).build(exporter, "story/mine_diamond");
        Advancement lv7 = Advancement.Builder.create().parent(lv4).display(Items.LAVA_BUCKET, (Text)Text.translatable("advancements.story.lava_bucket.title"), (Text)Text.translatable("advancements.story.lava_bucket.description"), null, AdvancementFrame.TASK, true, true, false).criterion("lava_bucket", InventoryChangedCriterion.Conditions.items(Items.LAVA_BUCKET)).build(exporter, "story/lava_bucket");
        Advancement lv8 = Advancement.Builder.create().parent(lv4).display(Items.IRON_CHESTPLATE, (Text)Text.translatable("advancements.story.obtain_armor.title"), (Text)Text.translatable("advancements.story.obtain_armor.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("iron_helmet", InventoryChangedCriterion.Conditions.items(Items.IRON_HELMET)).criterion("iron_chestplate", InventoryChangedCriterion.Conditions.items(Items.IRON_CHESTPLATE)).criterion("iron_leggings", InventoryChangedCriterion.Conditions.items(Items.IRON_LEGGINGS)).criterion("iron_boots", InventoryChangedCriterion.Conditions.items(Items.IRON_BOOTS)).build(exporter, "story/obtain_armor");
        ...
        Advancement lv9 = Advancement.Builder.create().parent(lv7).display(Blocks.OBSIDIAN, (Text)Text.translatable("advancements.story.form_obsidian.title"), (Text)Text.translatable("advancements.story.form_obsidian.description"), null, AdvancementFrame.TASK, true, true, false).criterion("obsidian", InventoryChangedCriterion.Conditions.items(Blocks.OBSIDIAN)).build(exporter, "story/form_obsidian");
        ...
        Advancement.Builder.create().parent(lv6).display(Items.DIAMOND_CHESTPLATE, (Text)Text.translatable("advancements.story.shiny_gear.title"), (Text)Text.translatable("advancements.story.shiny_gear.description"), null, AdvancementFrame.TASK, true, true, false).criteriaMerger(CriterionMerger.OR).criterion("diamond_helmet", InventoryChangedCriterion.Conditions.items(Items.DIAMOND_HELMET)).criterion("diamond_chestplate", InventoryChangedCriterion.Conditions.items(Items.DIAMOND_CHESTPLATE)).criterion("diamond_leggings", InventoryChangedCriterion.Conditions.items(Items.DIAMOND_LEGGINGS)).criterion("diamond_boots", InventoryChangedCriterion.Conditions.items(Items.DIAMOND_BOOTS)).build(exporter, "story/shiny_gear");
        ...
        Advancement lv11 = Advancement.Builder.create().parent(lv10).display(Items.ENDER_EYE, (Text)Text.translatable("advancements.story.follow_ender_eye.title"), (Text)Text.translatable("advancements.story.follow_ender_eye.description"), null, AdvancementFrame.TASK, true, true, false).criterion("in_stronghold", TickCriterion.Conditions.createLocation(LocationPredicate.feature(StructureKeys.STRONGHOLD))).build(exporter, "story/follow_ender_eye");
