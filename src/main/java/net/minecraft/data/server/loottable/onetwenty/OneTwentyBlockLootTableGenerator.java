...
extends BlockLootTableGenerator {
    ...
    protected void generate() {
        ...
        BlockStatePropertyLootCondition.Builder lv = BlockStatePropertyLootCondition.builder(Blocks.TORCHFLOWER_CROP).properties(StatePredicate.Builder.create().exactMatch(TorchflowerBlock.AGE, 2));
        this.addDrop(Blocks.TORCHFLOWER_CROP, this.applyExplosionDecay(Blocks.TORCHFLOWER_CROP, LootTable.builder().pool(LootPool.builder().with(((LeafEntry.Builder)ItemEntry.builder(Items.TORCHFLOWER).conditionally(lv)).alternatively(ItemEntry.builder(Items.TORCHFLOWER_SEEDS))))));
