...
public class EntityPredicate {
    ...
    public boolean test(ServerWorld world, @Nullable Vec3d pos, @Nullable Entity entity2) {
        ...
        if (this.steppingOn != LocationPredicate.ANY && !this.steppingOn.test(world, (lv = Vec3d.ofCenter(entity2.getLandingPos())).getX(), lv.getY(), lv.getZ())) {
            return false;
        }
        ...
        return this.team == null || (lv2 = entity2.getScoreboardTeam()) != null && this.team.equals(lv2.getName());
    }
    ...
    public static EntityPredicate fromJson(@Nullable JsonElement json) {
        ...
        EntityPredicate lv11 = EntityPredicate.fromJson(jsonObject.get("passenger"));
        EntityPredicate lv12 = EntityPredicate.fromJson(jsonObject.get("targeted_entity"));
