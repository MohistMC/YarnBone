...
public class DamageSourcePredicate {
    ...
    public boolean test(ServerWorld world, Vec3d pos, DamageSource damageSource) {
        ...
        for (TagPredicate<DamageType> lv : this.tagPredicates) {
    ...
    public static DamageSourcePredicate fromJson(@Nullable JsonElement json) {
        ...
        if (jsonArray != null) {
            ...
            for (JsonElement jsonElement2 : jsonArray) {
                list.add(TagPredicate.fromJson(jsonElement2, RegistryKeys.DAMAGE_TYPE));
            }
        } else {
            list = List.of();
        }
        ...
        return new DamageSourcePredicate(list, lv, lv2);
    }
