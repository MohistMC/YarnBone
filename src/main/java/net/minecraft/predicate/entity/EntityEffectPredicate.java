...
public class EntityEffectPredicate {
    ...
    public static EntityEffectPredicate fromJson(@Nullable JsonElement json) {
        ...
        for (Map.Entry<String, JsonElement> entry : jsonObject.entrySet()) {
            ...
            StatusEffect lv2 = Registries.STATUS_EFFECT.getOrEmpty(lv).orElseThrow(() -> new JsonSyntaxException("Unknown effect '" + lv + "'"));
            EffectData lv3 = EffectData.fromJson(JsonHelper.asObject(entry.getValue(), entry.getKey()));
            map.put(lv2, lv3);
        }
