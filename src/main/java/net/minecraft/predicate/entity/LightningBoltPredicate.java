...
implements TypeSpecificPredicate {
    ...
    public boolean test(Entity entity, ServerWorld world, @Nullable Vec3d pos) {
        ...
        return this.blocksSetOnFire.test(lv.getBlocksSetOnFire()) && (this.entityStruck == EntityPredicate.ANY || lv.getStruckEntities().anyMatch(struckEntity -> this.entityStruck.test(world, pos, (Entity)struckEntity)));
    }
}
